...
export default function Home({isShrinked, handleShrink}: Props) {
    ...
    return (
        <>
            <SideBar isShrinked={isShrinked} handleShrink={handleShrink} inPage='Home' />
            <input type="checkbox" checked={isShrinked} readOnly />
            <div className="main">
                <MainTop username='INWPUUN' topic='My Anime' />
                <ListAnime listAnime={listAnime} title='Home' />
            </div>
        </>
    )
}