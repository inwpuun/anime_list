...
export default function MyAnime({isShrinked, handleShrink}: Props) {
    ...
    return (
        <>
            <SideBar isShrinked={isShrinked} handleShrink={handleShrink} inPage='My Anime' />
            <input type="checkbox" checked={isShrinked} readOnly />
            <div className="main">
                <MainTop username='INWPUUN' topic='My Anime' />
                <ListAnime listAnime={listAnime} title='My Anime' />
            </div>
        </>
    )
}