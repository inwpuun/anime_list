...
export default function Planned({isShrinked, handleShrink}: Props) {
    ...
    return (
        <>
            <SideBar isShrinked={isShrinked} handleShrink={handleShrink} inPage='Planned' />
            <input type="checkbox" checked={isShrinked} readOnly />
            <div className="main">
                <MainTop username='INWPUUN' topic='My Anime' />
                <ListAnime listAnime={listAnime} title='Planned' />
            </div>
        </>
    )
}