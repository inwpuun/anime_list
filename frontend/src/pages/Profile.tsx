...
export default function Profile({isShrinked, handleShrink}: Props) {
    ...
    return (
        <>
            <SideBar isShrinked={isShrinked} handleShrink={handleShrink} inPage='Profile' />
            <input type="checkbox" checked={isShrinked} readOnly />
            <div className="main">
                <MainTop username='INWPUUN' topic='My Anime' />
                <ListAnime listAnime={listAnime} title='Profile' />
            </div>
        </>
    )
}